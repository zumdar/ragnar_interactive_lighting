...
int firmataPins [] = {18, 19, 20, 21, 22};
...
void followerOne() {
  while (HWSONE.available()) {
    ...
    if (followerValues[0] == 2) {
      digitalWrite(ledPin, HIGH);
      if (followerStates[0] == LOW) {
        digitalWrite(firmataPins[0], HIGH);
        followerStates[0] = HIGH;
      }
    }
    if (followerValues[0] == 0) {
      digitalWrite(ledPin, LOW);
      if (followerStates[0] == HIGH) {
        digitalWrite(firmataPins[0], LOW);
        followerStates[0] = LOW;
      }
    }
    //send on to td for pir 1
    if (followerValues[0] == 3) {
      digitalWrite(ledPin, HIGH);
      if (followerStates[1] == LOW) {
        digitalWrite(firmataPins[1], HIGH);
    ...
    if (followerValues[0] == 1) {
      ...
      if (followerStates[1] == HIGH) {
        digitalWrite(firmataPins[1], LOW);
...
void followerTwo() {
  while (HWSTWO.available()) {
    ...
    if (followerValues[2] == 2) {
      digitalWrite(ledPin, HIGH);
      if (followerStates[2] == LOW) {
        digitalWrite(firmataPins[2], HIGH);
        followerStates[2] = HIGH;
      }
    }
    
    if (followerValues[2] == 0) {
      digitalWrite(ledPin, LOW);
      if (followerStates[2] == HIGH) {
        digitalWrite(firmataPins[2], LOW);
...
void followerThree() {
  while (HWSTHREE.available()) {
    ...
    if (followerValues[3] == 2) {
      digitalWrite(ledPin, HIGH);
      if (followerStates[3] == LOW) {
        digitalWrite(firmataPins[3], HIGH);
        followerStates[3] = HIGH;
      }
    } 
    
    if(followerValues[3] == 0) {
      digitalWrite(ledPin, LOW);
      if (followerStates[3] == HIGH) {
        digitalWrite(firmataPins[3], LOW);
...
void followerFour() {
  while (HWSFOUR.available()) {
    ...
    if (followerValues[4] == 2) {
      digitalWrite(ledPin, HIGH);
      if (followerStates[4] == LOW) {
        digitalWrite(firmataPins[4], HIGH);
        followerStates[4] = HIGH;
      }
    } 
    
    if(followerValues[4] == 0) {
      digitalWrite(ledPin, LOW);
      if (followerStates[4] == HIGH) {
        digitalWrite(firmataPins[4], LOW);
